...
<html>
 ...
 <body>
     ...
     <div class="container">
         ...
         <br>
         <form action="return.php" class="container" method="get">
         ...
         <thead>
             ...
             <thbody>
                ...
                <td><?php echo $i ; ?></td>
                 ...
                 <td><a href="returndb.php?bid=<?php echo $rows['book_id'] ; ?>&mid=<?php echo $_GET['id']; ?>&rid=<?php echo $rows['rent_id'] ?>" > คืน </a></td>
